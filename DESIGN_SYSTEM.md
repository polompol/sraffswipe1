...
Палитра выгружена в Figma как переменные (28 штук: светлая и тёмная тема
отдельными коллекциями — бесплатный тариф разрешает один режим на коллекцию):

**https://www.figma.com/design/14SM2mRv7jZxqqoaeIkWUO**

Источник правды — всё равно `tma/src/theme/theme.css`. Если меняешь цвет
в коде, обнови и переменную в Figma, иначе файлы разъедутся.
