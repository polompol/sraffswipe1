...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Ничего. Смена, о которой вы договорились, закрывается сама через 12 часов после окончания — акт появится в разделе «Смены». Нажать что-то нужно только если смена НЕ состоялась: кнопка «Смена не состоялась» в мэтче.",
  },
  {
    q: "Зачем код от заведения?",
