...
const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "После договорённости в чате обе стороны жмут «Подтвердить смену». Акт появится в разделе «Смены» после того, как смена закроется — это происходит само через 12 часов после её окончания.",
  },
  {
