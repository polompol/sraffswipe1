    ...
    <div className="page">
      ...
      {role === "employer" && me && !!me.shiftsDone && me.shiftsDone > 0 && (
        <div className="card" style={{ marginBottom: 16 }}>
          ...
          <div className="muted" style={{ marginTop: 4, fontSize: 13 }}>
            {/* Знак даётся за ОПЛАЧЕННУЮ комиссию, а не за число закрытых
                смен: раньше здесь было написано обратное, и заведение могло
                считать, что знак заработается сам собой. */}
            Закрытые смены формируют рейтинг. Знак «Платит вовремя» появляется,
            когда комиссия за смены оплачена и нет просроченного счёта.
          </div>
        </div>
      )}
