...
export const IconLike = ({ size = 24, className }: P) => (
  <svg {...base(size)} className={className}>
    <path
      d="M12 20.4C12 20.4 3.4 14.6 3.4 9.1 3.4 6.2 5.5 4.3 7.8 4.3 9.6 4.3 11.2 5.4 12 6.9 12.8 5.4 14.4 4.3 16.2 4.3 18.5 4.3 20.6 6.2 20.6 9.1 20.6 14.6 12 20.4 12 20.4Z"
      fill="currentColor"
    />
  </svg>
);
